...
SINK_NAME = b'alsa_;[;[output.pci-0000_00_1a.0.analog-stereo'
METER_RATE = 16
...
class PeakMonitor(object):
    ...
    def sink_info_cb(self, context, sink_info_p, _, __):
        ...
        #print ('name:', sink_info.name.decode('ascii'))
        #print ('description:', sink_info.description.decode('ascii'))
        #print( sink_info.name.decode('ascii'))
        #print( sink_info.name)
        #print(self.sink_name.decode('ascii'))
